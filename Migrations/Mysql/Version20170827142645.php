 ...
 */
class Version20170827142645 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE dasoe_simpleteaser_domain_model_teaser CHANGE originalresource image VARCHAR(40) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE dasoe_simpleteaser_domain_model_teaser CHANGE image originalresource VARCHAR(40) DEFAULT NULL COLLATE utf8_unicode_ci');
